...
const Weather = () => {
  ...
  const search = async (city) => {
    ...
    try {
      ...
      setWeatherData({
        humidity: data.main.humidity, //Main bhitra ko humidity bhitra cha tei bhayera access gareko
  ...
  return (
    <div className="weather">
      <div className="search-bar">
        ...
        <img src={searchIcon} className='searchIcon' onClick={()=>search(inputRef.current.value)} />
      </div>

      <img src={weatherData.icon} alt="" className='weatherIcon' />
      <p className='temperature'>{weatherData.temperatue}°C</p>
